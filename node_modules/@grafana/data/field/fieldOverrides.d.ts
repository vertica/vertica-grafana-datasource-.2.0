import { ApplyFieldOverrideOptions, DataFrame, DynamicConfigValue, Field, FieldConfig, FieldOverrideContext, GrafanaTheme, InterpolateFunction, LinkModel, NumericRange, ScopedVars, TimeZone, ValueLinkConfig } from '../types';
...
export declare const getLinksSupplier: (frame: DataFrame, field: Field, fieldScopedVars: ScopedVars, replaceVariables: InterpolateFunction, options: {
    theme: GrafanaTheme;
    timeZone?: TimeZone;
