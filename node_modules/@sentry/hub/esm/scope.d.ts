import { Breadcrumb, CaptureContext, Context, Contexts, Event, EventHint, EventProcessor, Extra, Extras, Scope as ScopeInterface, Severity, Span, Transaction, User } from '@sentry/types';
/**
