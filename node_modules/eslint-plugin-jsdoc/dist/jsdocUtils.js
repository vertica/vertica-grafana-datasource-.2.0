...
const closureNamepathDefiningTags = new Set([// These appear to require a "name" in their signature, albeit these
...
'class', 'constructor', 'constant', 'const', 'function', 'func', 'method', 'member', 'var', 'mixin', 'namespace', // These seem to all require a "namepath" in their signatures (with no counter-examples)
'name', 'typedef', 'callback']);
const typescriptNamepathDefiningTags = new Set([...closureNamepathDefiningTags, // Allows for "name" in signature, but indicates as optional
'interface']);
...
'see']); // The following do not seem to allow curly brackets in their doc
//  signature or examples (besides `modifies` and `param`)

const tagsWithOptionalNamePosition = new Set([...namepathDefiningTags, ...tagsWithOptionalNamePositionBase]);
const typescriptTagsWithOptionalNamePosition = new Set([...typescriptNamepathDefiningTags, ...tagsWithOptionalNamePositionBase]);
