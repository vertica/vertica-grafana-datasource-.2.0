...
const getUtils = (node, jsdoc, jsdocNode, settings, report, context, iteratingAll, ruleConfig) => {
  ...
  utils.avoidDocs = () => {
    ...
    const exemptedBy = (_context$options$0$ex = (_context$options$2 = context.options[0]) === null || _context$options$2 === void 0 ? void 0 : _context$options$2.exemptedBy) !== null && _context$options$0$ex !== void 0 ? _context$options$0$ex : ['inheritDoc', ...(mode === 'closure' ? [] : ['inheritdoc'])];
  ...
  utils.tagMightHaveNamePosition = tagName => {
    return _jsdocUtils.default.tagMightHaveNamePosition(mode, tagName);
  };
  ...
  utils.isNamepathDefiningTag = tagName => {
    return _jsdocUtils.default.isNamepathDefiningTag(mode, tagName);
  };
