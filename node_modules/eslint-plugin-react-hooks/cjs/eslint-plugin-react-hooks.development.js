...
function collectRecommendations(_ref5) {
  ...
  function scanTreeRecursively(node, missingPaths, satisfyingPaths, keyToPath) {
    node.children.forEach(function (child, key) {
      var path = keyToPath(key); // For analyzing dependencies, we want the "normalized" path, without any optional chaining ("?.") operator
      // foo?.bar -> foo.bar
      ...
      if (child.isRequired) {
        ...
        missingPaths.add(normalizedPath); // If we got here, nothing in its subtree was satisfied.
