 ...
 * Version: 0.22.1(3e0f005166c42b8580665a8a3e486c76972c8bd0)
...
define("vs/editor/editor.main.nls.ru", {
	...
	"vs/editor/common/config/editorOptions": [
		...
		"Определяет размер шрифта встроенных указаний в редакторе. Если задано значение \"0\", то используется 90 % от \"#editor.fontSize#\".",
		...
		"Задает количество строк в редакторе, которые могут быть прочитаны средством чтения с экрана. Предупреждение: из-за технических ограничений это число не может превышать значение по умолчанию.",
	...
	"vs/platform/list/browser/listService": [
		...
		"Определяет, как развертываются папки дерева при щелчке имен папок.",
	],
